 ...
 * ↓ YOUR CODE HERE ↓ */
console.log(
`My friend ${friendsName} and ${myName} are eating ${food} and drinking ${drink}`)
...
//Answer: A const variable can't be changed
...
const lunchTime = (foodChoice, drinkChoice) => {
   return `My friend ${friendsName} and ${myName} are eating ${foodChoice} and drinking ${drinkChoice}`
}
console.log(lunchTime('Pizza','Water'));
...
HTMLFormControlsCollection.log(foodForTodayAndTomorrow('Pizza', 'Soda', lunchTime('Cheese', 'AppleJuice')));
